...
MIDDLEWARE_CLASSES = (
    ...
    'openedx.core.djangoapps.theming.middleware.ThemeRedirectMiddleware',
...
############## Settings for redirect URL for Themes ###############

THEME_REDIRECT_CACHE_TIMEOUT = 3600  # The length of time we cache REDIRECTED URL for themes
